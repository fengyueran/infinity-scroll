...
export default class SizeAndPositionManager {
  ...
  getTotalSize(): number {
    const lastMeasuredSizeAndPosition = this.getSizeAndPositionOfLastMeasuredItem();
    console.log("offset", lastMeasuredSizeAndPosition.offset);
    console.log("size", lastMeasuredSizeAndPosition.size);
    console.log("this.itemCount", this.itemCount);
    console.log("this.lastMeasuredIndex", this.lastMeasuredIndex);
    console.log("this.estimatedItemSize", this.estimatedItemSize);
    return (
